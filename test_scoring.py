...
class TestBlackJackScores(unittest.TestCase):
    def setUp(self):
        self.dealer_hand = []
        self.player_hand = []
        self.player_hands = []
    ...
    def test_one_ace_worth_eleven_points_blackjack(self):
        self.player_hand.append(("Spades", "Ace"))
        self.assertEqual(player_is_bust(self.player_hand), False)
        self.player_hand.append(("Spades", "Jack"))
        self.assertEqual(blackjack(self.player_hand), True)

    def test_one_ace_worth_eleven_points_no_blackjack(self):
        self.player_hand.append(("Spades", "Ace"))
        self.assertEqual(player_is_bust(self.player_hand), False)
        self.player_hand.append(("Spades", 9))
        self.assertEqual(calc_score(self.player_hand), 20)
        self.assertEqual(blackjack(self.player_hand), False)

    def test_one_ace_worth_eleven_points_multiple_cards(self):
        self.player_hand.append(("Spades", "Ace"))
        self.assertEqual(player_is_bust(self.player_hand), False)
